...
class Async<T> extends Equatable {
  ...
  const Async._(this.data, this.errorMessage, this._successWithoutData, this._loading);
  ...
  const Async.failure(String errorMessage): this._(null, errorMessage, false, false);
  const Async.initial(): this._(null, null, false, null);

  @override
  List<Object?> get props => [data, errorMessage, _successWithoutData, _loading];
}
